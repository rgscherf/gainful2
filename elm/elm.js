...
Elm.Main.make = function (_elm) {
   ...
   var Job = F4(function (a,b,c,d) {    return {title: a,organization: b,division: c,urlDetail: d};});
   var decodeJob = A5($Json$Decode.object4,
   Job,
   ...
   var viewJobs = F2(function (address,maybeJobs) {
      var tbody = function () {
         var _p2 = maybeJobs;
         if (_p2.ctor === "Nothing") {
               return _U.list([A2($Html.tr,_U.list([]),_U.list([A2($Html.td,_U.list([]),_U.list([])),A2($Html.td,_U.list([]),_U.list([]))]))]);
            } else {
